...
export class HQ {
  ...
  init() {
    ...
    // const hqTilemap = this.game.map.addTilesetImage("xmas", "xmas_sprite_sheet", 16, 16, margin, spacing);
    const xMasTileMap = this.game.map.addTilesetImage("xmas", "xmas_sprite_sheet", 16, 16, margin, spacing);
