...
const BOB_DEV_WBTC_ADDRESS = '0x77812A15bbEa11671e26449316B74B6695C23033'
const AVAX_DEV_WBTC_ADDRESS = '0x8592403d7D154CC997a375EE28C2C26EC96DF9f3'
// let DEV_WBTC_ADDRESS = AVAX_DEV_WBTC_ADDRESS
const PROD_WBTC_ADDRESS = '0x03c7054bcb39f7b2e5b2c7acb37583e32d70cfa3' // recheck snowtrace
...
function GetWbtcontractAddress() {
  ...
  if (process.env.REACT_APP_DEV_ENV === 'production') {
    ...
    if (connectedNetwork == 'AVALANCHE') {
      response = '0x152b9d0FdC40C096757F570A51E494bd4b943E50'
    } else if (connectedNetwork == 'BOB') {
      response = '0x03c7054bcb39f7b2e5b2c7acb37583e32d70cfa3'
    }
  } else {
    if (connectedNetwork == 'AVALANCHE') {
      response = AVAX_DEV_WBTC_ADDRESS
    } else if (connectedNetwork == 'BOB') {
      response = BOB_DEV_WBTC_ADDRESS
    }
  }
  return response
}

export { GetWbtcontractAddress }
