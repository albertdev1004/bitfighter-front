...
import { SetChangeInBalance, SetChangeInBalanceBool, SetChangeInCoin, SetChangesInBalanceInfo, SetSpiceBalance, SetWeb2CreditBalance, SetSpiceChange, SetTotalSpiceChange, SetTotalSpice } from "../stores/Web3StoreBalances";
...
export const UpdateUserNetwork = async () => {
  ...
  console.log("updateusernetwork", store.getState().web3store.web3Connected, store.getState().web3store.userAddress, store.getState().web3store.web3Network.toLowerCase())
  try {
